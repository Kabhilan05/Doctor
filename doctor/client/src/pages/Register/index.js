...
import bgimg from "../../images/Loginbg1.jpg";
  ...
  return (
    ...
    >
      <div className="  flex bg-slate-400/40 w-2/6 justify-center shadow-2xl shadow-slate-200 rounded-md  ">
        ...
        >
          <h1 className="text-3xl m-4 ">Welcome  Please Register 😊</h1>
          <Form.Item
          ...
          <Link to="/login" className="text-base text-neutral-950 hover:text-red-600" >
            {" "}
